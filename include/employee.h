...
public:
    ...
    Employee(Person &Person, int PayRate = 0, double DrinkSevice = 0, string EmployeeType = "null",int TimeWork);
    ~Employee();
    void display_infor();
...
Employee::Employee(string phone = "000000000", string name = "null", int PayRate = 0, double DrinkSevice = 0, string EmployeeType = "null",int TimeWork) : Person(phone, name), PayRate(PayRate), DrinkSevice(DrinkSevice), EmployeeType(EmployeeType),TimeWork(TimeWork)
{
}
Employee::Employee(Person &Person, int PayRate = 0, double DrinkSevice = 0, string EmployeeType = "null",int TimeWork) : Person(Person), PayRate(PayRate), DrinkSevice(DrinkSevice), EmployeeType(EmployeeType),TimeWork(TimeWork) {}
